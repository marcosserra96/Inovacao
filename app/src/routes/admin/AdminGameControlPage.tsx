            ...
            <>
              ...
              {control?.active_mode === 'individual' && (
                <div className="flex flex-col gap-3">
                  <Select value={control.active_individual_session_id ?? ''} onChange={(e) => setActiveSession(e.target.value)}>
                  ...
                  {sessions.length === 0 && (
                    <p className="text-sm text-ink-muted">
                      Nenhuma sessão individual criada ainda —{' '}
                      <Link to="/admin/sessoes" className="text-primary underline">
                        crie uma aqui
                      </Link>
                      .
                    </p>
