  ...
  return (
    <section className="relative z-10 flex min-h-0 flex-1 flex-col justify-center px-[clamp(8px,1.4vw,22px)]">
      <div className="mb-[clamp(10px,1.6vh,18px)] flex items-center justify-between gap-6">
        ...
        <div className="flex items-baseline gap-1 rounded-2xl border border-[#a7d52c]/20 bg-[#a7d52c]/8 px-[clamp(14px,2vw,24px)] py-[clamp(8px,1.2vh,14px)]">
          <span className="font-display text-[clamp(2rem,4.6vw,4.8rem)] font-extrabold leading-none text-[#a7d52c]">08</span><span className="text-[clamp(.8rem,1.1vw,1.1rem)] font-bold text-[#a7d52c]">s</span>
        </div>
      </div>
